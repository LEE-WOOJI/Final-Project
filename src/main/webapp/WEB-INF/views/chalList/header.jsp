            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        <li class="nav-item"><a class="nav-link" href="Glphy"><span id = "glphy">Glphy</span></a></li>
                        <li class="nav-item"><a class="nav-link" href="#Community"><span id = "community">Community</span></a></li>
