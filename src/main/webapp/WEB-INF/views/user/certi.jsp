				...
				<div class="module-inner">
						...
						<form action="/mypage/certiWriteForm" method="post">
							<div class="user-info">
								...
								<ul class="meta list list-unstyled">
									<li class="name">${user.nickname}<label
										class="label label-info">${user.grade }</label>
									</li>
									<li class="email"><a href="#"
										style="text-decoration: none;">${user.email}</a></li>
								</ul>
							</div>
							<nav class="side-menu">
								<ul class="nav">
					...
					<div class="content-panel">
								...
								<c:choose>
									<c:when test="${!empty list}">
										<c:forEach var="list" items="${list}">
											<div class="drive-item module text-center"
												style="width: 168px; height: 168px; font-family: 'yg-jalnan', verdana, tahoma; margin: 15px;">
												${list.certiTitle} <img class="img-responsive"
									...
									<c:otherwise>
										<div
											...
											인증하신 내역이 없습니다. <br> <br> <img alt=""
												src="/assets/img/noimage.jpg" style="align-items: center;">
										</div>
									</c:otherwise>
								</c:choose>
							</div>
						...
						<div class="drive-wrapper drive-list-view">
							<div class="table-responsive drive-items-table-wrapper"></div>
						</div>
					</div>
				</div>
			</section>
