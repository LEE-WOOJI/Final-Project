					...
					<div class="card-body">
						...
						<div class="fm-menu">
							...
							<div class="list-group list-group-flush">
								...
								<a href="/mypage/delete" class="list-group-item py-1">
				...
				<div class="table" id="presentG" style="height: 400px; overflow-y: scroll; overflow-x: hidden;"">
					...
					<c:forEach var="list" items="${plist}">
						...
						<div class="row" style="text-align: center; line-height: 30px; border: none;">
							...
							<div class="col-2" style="padding: 0px;">
								<a href="/mypage/certi?refChalSeq=${list.refChalSeq}&chalName=${list.chalName}" style="text-decoration-line: none;">
									<input type="button" value="인증" class="btn certi" style="background-color: #f8d2cd;">
								</a>
							</div>
						</div>
					</c:forEach>
