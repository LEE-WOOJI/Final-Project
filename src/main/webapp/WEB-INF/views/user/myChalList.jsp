	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-12 col-lg-9">
				<!-- 진행 중인 리스트 -->
				<div class="table" id="presentG"
					style="height: 400px; overflow-y: scroll; overflow-x: hidden;"">
					<h6 class="mt-3 mb-0"
						style="text-align: center; font-family: 'yg-jalnan', verdana, tahoma; color: #f86b58;">진행
						중인 글피!</h6>
					<br>
					<div class="row"
						style="text-align: center; line-height: 30px; border: none; background-color: #f8e8e6;">
					...
					<c:forEach var="list" items="${plist}">
						<br>
						<div class="row"
							style="text-align: center; line-height: 30px; border: none;">
							<div class="col-2" style="padding: 0px;">
								<a href="/chal/detail?seq=${list.refChalSeq}"
							...
							<div class="col-2" style="padding: 0px;">
								<a
									...
									value="인증" class="btn certi" style="background-color: #f8d2cd;">
								</a>
							</div>
						</div>
					</c:forEach>
						...
						<div class="row"
							...
							<div class="col-2" style="padding: 0px;">
								<a href='javascript:void(0);'
									onclick="cancle(${list.refChalSeq});"> <input type="button"
									value="취소" class="btn cancle"
									style="background-color: #f8d2cd;">
								</a> <input type="button" value="${list.refChalSeq }"
									class="btn seq"
									style="background-color: #f8d2cd; display: none;">
							</div>
						</div>
					</c:forEach>
				</div>
				<br> <br> <br>
				<!-- 완료한 글피 리스트 -->
				<div class="table" id="beforeG"
					style="height: 400px; overflow-y: scroll; overflow-x: hidden;"">
					<h6 class="mt-3 mb-0"
						style="text-align: center; font-family: 'yg-jalnan', verdana, tahoma; color: #f86b58;">완료한
						글피 리스트</h6>
					<br>
					<div class="row"
						style="text-align: center; line-height: 30px; border: none; background-color: #f8e8e6;">
					...
					<c:forEach var="list" items="${blist}">
						...
						<div class="row"
							...
							<div class="col-2" style="padding: 0px;">
								<a href='javascript:void(0);'
									onclick="refund(${list.refChalSeq});"> <input type="button"
