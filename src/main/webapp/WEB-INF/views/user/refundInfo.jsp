...
<body>
	<div id="popup">
        ...
        <main class="textBox">
            <h2 class="tit" style="font-family: 'yg-jalnan', verdana, tahoma;">${dto.nickname}님의 글피 결과</h2>
            ...
            <table align="center" style="width: 300px;">
                ...
                <tr>
                    ...
                    <td>
                        <fmt:formatDate pattern="yyyy년 MM월 dd일" value="${startDate }~${endDate }" />
                    </td>
                </tr>
                <tr>
            ...
            <p style="font-family: 'yg-jalnan', verdana, tahoma;"><strong >환급 계좌 정보</strong></p>
            ...
            <input type="text" name="account" placeholder=" - 제외한 숫자만 입력해주세요"
             style="width: 300px; text-align: center;  font-family: 'S-CoreDream-4Regular'" >
            <br>
            <br>
            <p style="font-family: 'yg-jalnan', verdana, tahoma;"><strong>환급 금액</strong></p>
            <input type="text"  value="${dto.price}원" placeholder="- 제외한 숫자만 입력해주세요"
                style="width: 200px; text-align: center; font-family: 'S-CoreDream-4Regular'" readonly>
            <br>
            ...
            <button type="button" class="btn btn-danger"  style="font-family: 'S-CoreDream-4Regular'" > 환급 </button>
            <button type="button" class="btn btn-danger"  style="font-family: 'S-CoreDream-4Regular';">취소</button>
            <br>
            <br>
        </main>
    </div>
