	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-12 col-lg-9">
				<div class="card">
					<div class="card-body">
						<form action ="/admin/userBlackSearch">
							<div class="row mt-3">
							...
							<div class="col-sm-12 col-md-3 col-lg-3">
								<input type="text" class="form-control"
									placeholder="블랙 여부를 입력하세요" aria-label="Recipient's username"
									aria-describedby="basic-addon2" name="blacklist">
							</div>
					...
					<div class="table" id = "table" style="overflow-x: hidden;">
						<h6 class="mt-3 mb-0" style="text-align: center; font-family: 'yg-jalnan', verdana, tahoma;">유저
							검색 결과</h6>
						<br>
						<div class="row" style="text-align: center; line-height: 30px; border: none;">
							...
							<div class="col-1 list" style="padding: 0px;">탈퇴</div>
						...
						<c:forEach var="list" items="${list}">
							...
							<div class="row" style="text-align: center; line-height: 30px; border: none;">
								...
								<div class="col-1" style="padding: 0px;">
									<a href="/admin/userBlackDelete?id=${list.id}"
										style="text-decoration-line: none;"> <input type="button"
										value="탈퇴" class="btn outBtn"
										style="background-color: rgba(245, 188, 188, 0.65);">
									</a>
								</div>
								<div class="col-1" style="padding: 0px;">
									<a
										href="/admin/userBlackStop?id=${list.id}&blacklist=${list.blacklist}"
										style="text-decoration-line: none;"> <input type="button"
										value="블랙" class="btn stopBtn"
										style="background-color: rgba(245, 188, 188, 0.65);">
									</a>
								</div>
							</div>
	...
	<script>
		...
		let blacklist = "${blacklist}";
   		$("#more").on("click",function(){
   			moreNum += 5;
   			$.ajax({
   				url:"/admin/userBlackSearchMore",
   				method:"POST",
   				data:{"moreNum":moreNum,"id":id,"nickname":nickname,"blacklist":blacklist}
   			}).done(function(resp){
   				...
   				for(let i = 0; i < result.length; i++){
   					...
   					content += `<br><div class="row" style="text-align: center; line-height: 30px; border: none;">
						...
						<div class="col-1" style="padding: 0px;">
							<a href="/admin/userBlackDelete?id=\${result[i].id}"
								style="text-decoration-line: none;"> <input type="button"
								value="탈퇴" class="btn outBtn"
								style="background-color: rgba(245, 188, 188, 0.65);">
							</a>
						...
						<div class="col-1" style="padding: 0px;">
							<a
								href="/admin/userBlackStop?id=\${result[i].id}&blacklist=\${result[i].blacklist}"
								style="text-decoration-line: none;"> <input type="button"
								value="블랙" class="btn stopBtn"
								style="background-color: rgba(245, 188, 188, 0.65);">
							</a>
